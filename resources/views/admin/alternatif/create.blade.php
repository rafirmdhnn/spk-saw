...
<a href="{{route('alternatif.create')}}">
    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Tambah Alternatif</h5>
</a>
@endsection
@section('content')
<!--begin::Entry-->
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Tambah Alternatif</h3>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="mb-15">
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Masukan Link Scrapping 
                            <span class="text-danger">*</span>
                        </label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control" placeholder="Masukkan Masukkan Link Scrapping" value="{{ old('link_scrapping') }}" name="link_scrapping">
                        </div>
                    </div>
                </div>
            </div>
