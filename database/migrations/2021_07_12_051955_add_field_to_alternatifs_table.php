...
class AddFieldToAlternatifsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('alternatifs', function (Blueprint $table) {
            $table->dropColumn(['alternatif_image','alternatif_harga','alternatif_ukuran_layar','alternatif_baterai','alternatif_storage','alternatif_kamera','alternatif_ram']);
        });
    }
}
